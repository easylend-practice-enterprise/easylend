...
$EnvMappings = @(
    @{
        ...
        AllowedKeys  = @(
            ...
            "JWT_SECRET_KEY", "CORS_ORIGINS", "DOCS_USERNAME", "DOCS_PASSWORD",
            "VISION_SERVICE_URL", "VISION_API_KEY", "VISION_BOX_API_KEY", "SIMULATION_API_KEY"
        )
        RequiredKeys = @(
