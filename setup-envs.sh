...
declare -a MAPPINGS=(
  ...
  "FastAPI Backend|backend/api/.env|ENVIRONMENT JWT_SECRET_KEY DATABASE_URL REDIS_URL VISION_BOX_API_KEY SIMULATION_API_KEY VISION_SERVICE_URL SIMULATION_SERVICE_URL VISION_API_KEY DOCS_USERNAME DOCS_PASSWORD CORS_ORIGINS|ENVIRONMENT JWT_SECRET_KEY DATABASE_URL REDIS_URL VISION_BOX_API_KEY SIMULATION_API_KEY VISION_API_KEY CORS_ORIGINS"
